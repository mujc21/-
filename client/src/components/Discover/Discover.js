    ...
    render() {
        return <div class='zgw_discover' style={this.props.Main_Style}>
            <div style={{display: 'flex'}}>
                ...
                <p style={{position: 'absolute', left: '65.85vw', top: '4vh'}}>排序方式</p>
                <SelectBar Select_Bar_Style={{position: 'absolute', left: '72vw', top: '5.875vh', width: '120px', height: '25px', fontSize:'12px'}} Select_Bar_Options={['点赞最多','收藏最多','最新发布']} Select_Bar_Changed={this.fun_Select_Bar_changed}/>
            </div>
            <DiscoverList Discover_List_Style={this.props.Discover_List_Style} Search_String={this.state.Final_Search_Content} select_Bar_State={this.state.select_Bar_State} currentUser={this.props.currentUser} selfAvatar={this.props.selfAvatar}/>
            </div>
    }
}

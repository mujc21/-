...
# add
_C.benchmark_dir = osp.join(_C.output_dir, 'benchmark')
...
# 显存不够，限制一下
_C.train.point_limit = 30000  # 30000
...
_C.backbone.init_radius = _C.backbone.base_radius * _C.backbone.init_voxel_size  # 这是什么radius？？？
...
_C.geotransformer.sigma_rgb = 0.1
_C.geotransformer.sigma_dps = 0.1
_C.geotransformer.rgb_id_like='rgb'
...
_C.train.meta_path_train = '''/home2/lirenjie/data/3DMatchNPY/raw/meta_train_{}.txt'''.format(_C.dp_knn)
_C.train.meta_path_valid = '''/home2/lirenjie/data/3DMatchNPY/raw/meta_val_{}.txt'''.format(_C.dp_knn)
_C.test.meta_path= '''/home2/lirenjie/data/3DMatchNPY/raw/meta_test_{}.txt'''.format(_C.dp_knn)

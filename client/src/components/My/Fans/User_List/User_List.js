...
const FanList = ({UserListStyle, currentUser, currentEnter}) => {
    ...
    async function handleFansNumber(username){
        const myurl = 'http://43.138.68.84:8082/api/FansNumber/' + username
    ...
    async function handleFansAvatar(username, ordinal){
        const myurl = 'http://43.138.68.84:8082/api/FansAvatar/' + username + '/' + ordinal
        return new Promise((resolve, reject) => {
            axios.get(myurl,{
    ...
    async function handleFansUsername(username, ordinal){
        const myurl = 'http://43.138.68.84:8082/api/FansUsername/' + username + '/' + ordinal
        return new Promise((resolve, reject) => {
            axios.get(myurl)
            .then(res => {
              if (res.data === "数据库查询失败") {

    ...
    render() {
        return <div class='zgw_discover' style={this.props.Main_Style}>
            <div style={{display: 'flex'}}>
                ...
                <SelectBar Select_Bar_Style={{position: 'absolute', right: '13.5%', top: '5.875%', width: '120px', height: '25px', fontSize:'12px'}} Select_Bar_Options={['点赞最多','收藏最多','最新发布']} Select_Bar_Changed={this.fun_Select_Bar_changed}/>
            </div>

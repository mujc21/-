...
export default class Reply extends Component {
    ...
    render(){
        ...
        return <div style={this.props.Main_Style} class="zgw_Reply_List">
          <Link to='/mails'>
            <BackButton  Back_Button_Style = {Back_Button_Style}/>
          </Link> 
          <p class="zgw_Reply_Label">回复</p>
          <div style={Reply_Content}>
            <List
                      ...
                      <div>
                        <div style={{width: '84vw', marginLeft: '30px'}}>
                          <div style={{display: 'flex', marginLeft: '-10px'}}>
                            <Avatar src={item.picture.large} style={{ height: '50px', width: '50px', marginTop: '10px'}}/>
                            ...
                            <p style={{color: 'rgb(64, 64, 64)', marginLeft: '5px', marginTop: '14px', fontWeight: '400'}}>评论了我的帖子</p>
                          </div>
                          <p style={{marginLeft: '55px', marginTop: '-15px', fontWeight: '500'}}>Ant Design, a design language for background applications, is refined by Ant UED Team hhhhhhhh hhhhhhhhhAnt Design, a design language for background applications, hh</p>
                        </div>

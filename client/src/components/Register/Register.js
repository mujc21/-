...
export default class Login extends Component {
    ...
    render() {
        ...
        return <div style={divStyle}> 
                ...
                {this.props.isOpen && ((this.props.RegisterReminderString === "用户名长度应为2-15位，请重新输入" || this.props.RegisterReminderString === "响应失败，请重试" || this.props.RegisterReminderString === "用户被占用，请重新输入")

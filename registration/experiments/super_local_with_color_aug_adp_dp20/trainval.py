...
from dataset import train_valid_data_loader, train_valid_color_data_loader
from model import create_model
from loss import OverallLoss, Evaluator


class Trainer(EpochBasedTrainer):
    def __init__(self, cfg, exclude_input=[]):
        ...
        train_loader, val_loader, neighbor_limits = train_valid_color_data_loader(cfg, self.distributed)
...
def main():
    cfg = make_cfg()
    trainer = Trainer(cfg, exclude_input=['dps'])
    trainer.run()

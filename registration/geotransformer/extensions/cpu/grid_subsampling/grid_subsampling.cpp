...
// step into 1.2.1.1.1 : 下采样，这里就是跳过去了，文件在'geotransformer/extensions/cpu/grid_subsampling/grid_subsampling.cpp'
std::vector<at::Tensor> grid_subsampling(
  ...
  // 至此已经将下采样得到的点全部放进了vec_s_points和vec_s_dps中，方法是将每个点云中的点按照到“最小点”的坐标进行采样，取上采样点坐标平均值
